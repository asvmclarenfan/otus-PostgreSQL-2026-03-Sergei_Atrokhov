...
####
Для согласованного отчета (на конкретный момент времени) при параллельной записи данных рекомендуется использовать уровень изоляции REPEATABLE READ, а не READ COMMITTED.
####
